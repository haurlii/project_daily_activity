    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <a href="/" class="lg:hidden">
                <img class="dark:hidden" src="{{ asset('./assets/images/logo/logo-circle-blue.svg') }}"
                    alt="DAC Indonesia" />
                <img class="hidden dark:block" src="{{ asset('./assets/images/logo/logo-circle-blue.svg') }}"
                    alt="DAC Indonesia" />
            </a>
                ...
                <form>
                    <div class="relative">
                        ...
                        <input type="text" placeholder="Search or type command..." id="search-input"
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pr-14 pl-12 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden xl:w-[430px] dark:border-gray-800 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30" />
                        ...
                        <li>
                            ...
                            {{ 
                                match(auth()->user()->role) {
                                    'SuperAdmin'  => route('admin.users.showProfile'),
                                    'Leader' => route('leader.users.showProfile'),
                                    'Member' => route('member.users.showProfile'),
                                    default  => '#',
                                } 
                            }}"
