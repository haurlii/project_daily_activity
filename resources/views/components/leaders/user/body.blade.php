            ...
            <tr class="border-b dark:border-gray-700">
                ...
                <td class="px-6 py-3">
                    <div class="flex items-center gap-3 mr-3 max-w-2xl">
                        ...
                        <img src="{{ asset('assets/images/user/user-default.png') }}" alt="{{ $user->name }}"
                ...
                <td class="px-6 py-3 flex items-center justify-end">
                    ...
                    <div id="user-{{ $user->id }}-dropdown"
                        ...
                        <ul class="py-1 text-sm" aria-labelledby="user-{{ $user->id }}-dropdown-button">
                            <li>
                                <a href="{{ route('leader.users.edit', $user->id) }}"
                ...
                <div class="relative w-full max-w-[600px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
                    ...
                    <div class="text-center">
                        ...
                        <div class="flex items-center justify-center w-full gap-3 mt-7">
                            ...
                            <form action="{{ route('leader.users.destroy', $user->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
