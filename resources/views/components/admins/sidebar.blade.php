<!-- Menu Item Dashboard -->
<li>
    <a href="{{ route('admin.indexAdmin') }}" @click="selected = (selected === 'Dashboard' ? '':'Dashboard')"
...
<li>
    <a href="{{ route('admin.users.index') }}" @click="selected = (selected === 'Data Karyawan' ? '':'Data Karyawan')"
        class="menu-item group hover:menu-item-active"
        :class="(page === 'Data Karyawan') ? 'menu-item-active' : 'menu-item-inactive'">
        <!-- || page === 'Tambah Karyawan' || page === 'Update Karyawan' || page === 'Delete Karyawan' -->
        <svg :class="(page === 'Data Karyawan') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24"
            height="24" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd"
...
<!-- Menu Item Tugas -->
<li>
    <a href="{{ route('admin.tasks.index') }}" @click="selected = (selected === 'Tugas' ? '':'Tugas')"
        class="menu-item group hover:menu-item-active"
        :class="(page === 'Data Tugas') ? 'menu-item-active' : 'menu-item-inactive'">
        <!-- || page === 'Tambah Tugas' || page === 'Update Tugas' || page === 'Update Tugas' -->
        <svg :class="(page === 'Data Tugas') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24"
...
<!-- Menu Item Aktivitas -->
<li>
    <a href="{{ route('admin.activities.index') }}" @click="selected = (selected === 'Aktivitas' ? '':'Aktivitas')"
        class="menu-item group" :class="(page === 'Data Aktivitas') ? 'menu-item-active' : 'menu-item-inactive'">
        <!-- || page === 'Tambah Aktivitas' || page === 'Update Aktivitas' || page === 'Delete Aktivitas' -->
        <svg :class="(page === 'Data Aktivitas') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24"
            height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
            <path fill-rule="evenodd" clip-rule="evenodd"
