...
=======
                            <!-- Button View -->
                            <li><button type="button" data-modal-target="showTaskModal-{{ $task->id }}"
                                    data-modal-toggle="showTaskModal-{{ $task->id }}" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600
...
>>>>>>> 8a277de5cbda6fc8184fdedd62ff144fc5499470
                            ...
                            <li>
                                <a href="{{ route('member.tasks.pendingActivity', $task->id) }}"
                                    class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                    <svg class="w-5 h-5 mr-2" viewBox="0 0 24 25" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
                                        <path
    ...
    <div class="relative w-full h-full p-0">
        ...
        <div class="relative flex h-full w-full flex-col bg-white dark:bg-gray-800">
            ...
            <div class="flex-1 overflow-y-auto p-6">
                <p class="text-sm leading-6 text-gray-500 dark:text-gray-400">Judul Tugas: {{ $task->title }}</p>
                <p class="text-sm leading-6 text-gray-500 dark:text-gray-400">Status Tugas: @if ( $task->status ===
