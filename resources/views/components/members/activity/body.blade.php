...
<div class="overflow-x-auto">
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
                ...
                <td class="px-6 py-3 flex items-center justify-end">
                    ...
                    <div id="activity-{{ $activity->id }}-dropdown"
                        ...
                        <ul class="py-1 text-sm" aria-labelledby="activity-{{ $activity->id }}-dropdown-button">
                            <!-- Button View -->
                            <li>
                                <<<<<<< HEAD <button type="button" data-modal-target="fullscreen-modal"
                                    data-modal-toggle="fullscreen-modal"=======<button
                                    data-modal-target="showActivityModal-{{ $activity->id }}"
            ...
            {{-- <div id="showActivityModal-{{ $activity->id }}"
            class="fixed top-0 hidden left-0 z-999999 flex h-screen w-full flex-col items-stretch justify-between
