    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="border-b dark:border-gray-700">
                ...
                <td class="px-6 py-3">
                    <div class="flex items-center mr-3 whitespace-nowrap max-w-xl">
                        {{ $activity->start_date->translatedFormat('d F Y, H:i') ?? 'Tidak tersedia' }}
                    </div>
                </td>
                <td class="px-6 py-3">
                    <div class="flex items-center mr-3 whitespace-nowrap max-w-xl">
                        {{ $activity->end_date ? $activity->end_date->translatedFormat('d F Y, H:i') : 'Tidak tersedia' }}
                    </div>
                </td>
                <td class="px-6 py-3">
                    <div class="flex items-center mr-3 whitespace-nowrap max-w-xl">
...
{{-- <div id="showActivityModal-{{ $activity->id }}"
class="fixed top-0 hidden left-0 z-999999 flex h-screen w-full flex-col items-start justify-start overflow-x-hidden
bg-white p-6 lg:p-10 dark:bg-gray-900"
style="">
<!-- close btn -->
<button data-modal-target="showActivityModal-{{ $activity->id }}"
    data-modal-toggle="showActivityModal-{{ $activity->id }}"
    ...
    <div class="relative w-full max-w-[600px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
        ...
        <div class="text-center">
            <div class="relative flex items-center justify-center z-1 mb-7">
                <svg class="fill-warning-50 dark:fill-warning-500/15" width="90" height="90" viewBox="0 0 90 90"
