<h1 align="center" style="font-size: 1.5rem; font-weight: 700;">Data Karyawan</h1>
<h3 align="center" style="font-size: 1.125rem; font-weight: 500;"> Hari, Tanggal : {{
    \Carbon\Carbon::now()->translatedFormat('l, d M Y') }}</h3>
<hr>
<table width="100%" border='1px'
    style="border-collapse: collapse; font-size: 0.75rem; table-layout: auto; margin-bottom: 32px;">
    <thead>
        <tr>
...
<table width="100%" style="margin-top: 32px; font-size: 0.875rem; border-collapse: collapse;">
    <tr>
        <!-- Kolom Kiri -->
        <td align="left" style="vertical-align: top;">
            <p><strong>Total Karyawan:</strong> 5</p>
            <p><strong>Total Divisi:</strong> 4</p>
