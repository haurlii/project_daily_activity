...
<x-layouts.guest :title="$title">
    <!-- Form -->
    <x-partials.form-login />
    {{--
    <x-partials.logo-login /> --}}
...
<head>
    ...
    <title>Daily Activity - Login Akun Multi-Role</title>
    ...
    <style>
        ...
        body.bg-gambar-login {
            background: url("{{ asset('assets/img/bgg.jpg') }}") no-repeat center center fixed; 
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <img src="{{ asset('assets/img/Logo dac.webp') }}" 
                                            alt="Logo Perusahaan" 
                                            style="max-width: 150px; margin-bottom: 25px;"> 
                                        <h1 class="h5 text-gray-900 mb-2"> 
                                            <span class="font-weight-bold">Daily Activity DAC Group</span>
                                        </h1>
                                        <div class="mb-4 text-gray-600">
                                            Selamat Datang! Pilih Role Anda untuk Login
                                        </div>
                                    </div>
                                    
                                    <form method="post" class="user" id="loginForm" onsubmit="event.preventDefault(); login();">
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="password" class="form-control form-control-user"
                                                id="inputPassword" placeholder="Kata Sandi" required>
                                        </div>
